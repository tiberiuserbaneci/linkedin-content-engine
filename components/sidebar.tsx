...
export function Sidebar({ profiles, selectedId, onSelect, onAddProfile, onDelete, onRefresh }: SidebarProps) {
  return (
    <aside className="w-72 border-r border-[#1E1E1E] bg-[#0A0A0A] flex flex-col h-full">
      <div className="p-4 border-b border-[#1E1E1E] space-y-2">
        <button
        ...
        <Link
          href="/vc-outreach"
          className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-[#1E1E1E] text-[#999] rounded-lg text-sm hover:text-[#F1F1F1] hover:bg-[#252525] transition-colors"
        >
